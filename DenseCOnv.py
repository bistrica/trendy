import math
from lasagne.layers import InputLayer, Conv2DLayer, NonlinearityLayer, Pool2DLayer, MaxPool2DLayer, ScaleLayer, \
    BiasLayer, ConcatLayer, DropoutLayer, GlobalPoolLayer, DenseLayer
